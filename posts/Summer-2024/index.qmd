...
Now, I have sufficient reasons to be interested in the problem. With the help of some simple python, I have verified the contrapositive of the conjecture for all pairs of non-isomorphic graphs on upto 10 vertices which is roughly $1,229,2182$ many graphs. It seems like for small number of vertices, the condition does determine all graphs upto isomorphism. Right now, I am interested in special classes of graphs such as trees and regular graphs. 
